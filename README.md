# UNIX-Shell
This is a homework assignment for class. In CSC331 Operating Systems we are using a lot of xv6 kernel. This assignment we had to create our own UNIX shell.
